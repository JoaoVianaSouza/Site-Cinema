   ...
   if($oper == 1) {
    ...
    if($oper == 3){
        ...
        if($quantidade > 0){
            ...
            echo "
                <link rel='shortcut icon' href='favicon1.ico' type='image/x-icon'>
                Mural Solidário não Encontrado
                <hr>
                        ...
                        <fieldset class='border2'>
                            ...
                            <fieldset class='border1'> 
                                <form action='cadastro.php' method='GET' class='altere'>  
                                    ...
                                    <h3>Sexo: </h3>  <input type=text name=sexo value='$sex'> <br>   
                                    <h3>Data de Nascimento: </h3>  <input type=date name=data_nascimento value='$nasc'> <br>
                                    <h3>Filme: </h3>  <input type=text name=filme value='$film'> <br>
                                    <h3>Sessão: </h3>  <input type=text name=sessao value='$ses'> <br>
                                    <h3>Tipo de ingresso: </h3> <input type=text name=tipo_ingresso value='$ting'> <br>
                                    <input type=hidden name=cpf value=$cpf>
                                    <input type=hidden name=op value=$oper>
                                    <input type=hidden name=entrada value=3> <br>     
                            </fieldset>
